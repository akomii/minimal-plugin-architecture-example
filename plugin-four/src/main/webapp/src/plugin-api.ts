...
function normalizeModuleExport(manifest: FrontendPluginManifest, mod: FrontendPluginModule): LoadedFrontendPlugin {
...
export async function loadFrontendPlugin(manifest: FrontendPluginManifest): Promise<LoadedFrontendPlugin> {
